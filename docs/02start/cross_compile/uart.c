// From:
// http://git.ti.com/pru-software-support-package/pru-software-support-package/trees/master/examples/am335x/PRU_Hardware_UART
...
int main(void) {
  ...
  /* Set up UART to function at 115200 baud - DLL divisor is 104 at 16x
   * oversample 192MHz / 104 / 16 = ~115200 */
  CT_UART.DLL = 104;
  CT_UART.DLH = 0;
  CT_UART.MDR = 0x0;

...
int main(void) {
  ...
  unsigned int on = (1 << 15) + (1 << 20);
  while (1) {
    __R30 = __R30 | (1 << 20); // pr2_pru1_gpo15 P8_10 // pr2_pru1_gpo20 P8_43
                               // __delay_cycles(50);        // Wait 1/2 second
    __delay_cycles(5);
    __R30 = __R30 | (1 << 15); // pr2_pru1_gpo15 P8_10 // pr2_pru1_gpo20 P8_43
    __delay_cycles(100000000);
    __R30 = __R30 & ~on; // pr2_pru1_gpo15 P8_10 pr2_pru1_gpo20P8_43
